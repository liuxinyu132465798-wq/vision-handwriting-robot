...
class HandwritingGCodeApp:
    def __init__(self):
        ...
        default_runner = Path(__file__).resolve().parent / "local_inksight_runner.py"
self.inksight_runner_var = tk.StringVar(value=str(default_runner))
    ...
    def run_inksight(self, img_path, prompt_mode="recognize", output_suffix=""):
        ...
        runner_win = str(Path(self.inksight_runner_var.get().strip()).expanduser().resolve())
wsl_runner = self.win_to_wsl_path(runner_win)
